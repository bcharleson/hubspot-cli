import type { CommandDefinition, HubSpotClient } from './types.js';
 ...
 * that key (e.g., bodyWrapper: "properties" → { properties: { ...body } })
 */
export async function executeCommand(
  ...
  // Wrap body fields if bodyWrapper is specified (e.g., HubSpot CRM: { properties: { ... } })
